...
La campaña corrió sobre `af581554`, árbol limpio, máquina drenada. 18 min 42 s.

> **Corregido.** Esta línea decía `95cf64bf`, que era el HEAD cuando **escribí** el
> acta, no cuando **corrió** la campaña. Lo cazó el juez de cierre. La cifra sigue
> siendo válida y la prueba es reproducible: `git diff --stat 95cf64bf HEAD -- backend/`
> sale **vacío**, o sea que el fuente de backend es idéntico, y `af581554..HEAD` sólo
> toca `progress/`. Se corrige igual, porque anotar mal un SHA es el primer paso hacia
> un informe irreproducible, que es justo el bloqueante que esta campaña cerró.
