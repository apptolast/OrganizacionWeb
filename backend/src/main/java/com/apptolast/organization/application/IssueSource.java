...
/**
 * Puerto de salida hacia el gestor de issues. El caso de uso no conoce GitHub ni GitLab: sólo este
 * puerto, {@link com.apptolast.organization.domain.ExternalIssue} y los códigos de {@link
 * IssueSourceException}. Un tercer gestor implementa este mismo puerto sin tocar nada más.
 *
