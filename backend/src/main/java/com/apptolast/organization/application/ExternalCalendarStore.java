...
public interface ExternalCalendarStore {
  ...
  /**
   * Conserva la dirección, así que conserva instantánea, contadores y estado. Vuelve a sellarla con
   * un nonce nuevo: dos escrituras de la misma dirección nunca dejan el mismo cifrado.
   */
  StoredSubscription relabel(String ownerId, String label, byte[] urlCiphertext, Instant now);
