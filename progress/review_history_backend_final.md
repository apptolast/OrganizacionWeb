...
La fecha0001 reveló dos defectos reales corregidos: JSON de timestamptz dependía de la zona de conexión y Timestamp usaba un calendario híbrido. UTC explícito en JSON y OffsetDateTime en lectura/cursor conservan los extremos contractuales. Los oráculos reales de PostgreSQL comprueban extremos, orden, inserciones tardías, cinco propietarios y snapshot por petición con escritor coordinado. No se promete snapshot entre páginas.
