...
# Salida UTF-8 en cualquier plataforma: Windows usa cp1252 por defecto y
# rompería con los caracteres de dibujo (─). Best-effort, no falla si el
# stream no admite reconfigure.
