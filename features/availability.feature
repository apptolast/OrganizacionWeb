...
Feature: Definir zona y presupuesto diario personal sin reservar horarios
  Contrato aprobado por autorización global del usuario después del cierre de complete_reopen_task.
  47 escenarios y 237 casos expandidos; decisiones técnicas en la sección Feature 10 de project-spec.md.
