...
- Funcionalidad15 aprobada localmente, pendiente de integración final en PR14:1890 pruebas Java,1668 frontend, smoke real y515 medidas responsive/35axe0. PIT523/525 y Stryker741/861 superan el umbral, con residuos documentados. CI9fc414e pasó108E2E; una ejecución posterior detectó un fixture sensible al orden, corregido y revisado en2e492a0. CI34077907038 valida ese arreglo. Descontando conservadoramente las tres detecciones de mutación atribuidas al fixture anterior,738/861=85,71% mantiene el umbral. No hay cambio productivo en esa corrección.
- Funcionalidad16 tiene propuesta revisada; se está destilando el contrato antes de implementar.17–18 siguen pendientes.
