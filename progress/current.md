...
Importación continúa en tres frentes: persistencia y validación de las catorce colecciones, interfaz y conservación de borradores, y lector estricto. HTTP y proxy tienen corte parcial revisado de 62 pruebas HTTP y 15 por socket con permisos equivalentes a producción; no acreditan todavía importación completa. El nuevo staging corrige casos reales de NUL y surrogate no pareado sin adelantar validaciones semánticas al hash. Quedan integración final, pruebas globales, mutación, navegador, rollback y aceptación en servidor sólo mediante preview. Detalle y límites en review_import_data_checkpoints.md.
