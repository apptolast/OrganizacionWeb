...
test("start_work_session: states preserve layout with text enlarged to 200 percent @s28 @s32 @s33 @s40 @s41", async ({
  page,
  request,
}) => {
  ...
  const folder = `.e2e-work/start-work-real/${engine}/text200`;
