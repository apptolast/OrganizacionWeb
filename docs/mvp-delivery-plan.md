...
Actualizado el 7 de septiembre de 2026. Objetivo: terminar hoy. Estimación vigente desde el cierre de la funcionalidad 17: **5–9 horas efectivas para el software**, más **4–8 horas para el despliegue**, condicionado a acceso, dominio y capacidad del servidor. Confianza media-baja en software y baja en despliegue. No es una garantía ni una predicción de consumo de cuota.
...
La funcionalidad18, Historial, tiene su implementación revisada e integrada; sigue en validación con tres agentes. El contrato aprobado contiene39escenarios y142ejemplos, que no equivalen a pruebas ejecutadas. La regresión general ha pasado con2.211Java,1.887frontend y47Node. El frontend se volvió a validar tras corregir el foco de navegación; build y formato de los estilos finales también pasan. Hay cuatro recorridos E2E focales y un primer UX con155mediciones y5axe sin incidencias. PIT y Stryker están en ejecución; faltan sus resultados, completar UX/otros motores, el E2E global del corte final y CI. Estos avances no acreditan todavía el cierre de18 ni el despliegue.

## Trabajo pendiente

| Hito | Resultado verificable | Horas efectivas |
| --- | --- | ---: |
| Historial | Cinco fuentes durables, detalles, filtros, paginación, privacidad y pruebas | 2,5–4,5 |
| Integración final | Revisión, recorrido conjunto y CI del corte final | 1–2 |
| Margen de correcciones | Defectos concretos de integración, pruebas o herramientas | 1,5–2,5 |
| Software restante | Ejecución coordinada, no horas-persona | **5–9** |
| Despliegue condicionado | Swarm, HTTPS, persistencia, reinicio, respaldo, restauración y reversión | **4–8 adicionales** |

Este rango sustituye la estimación anterior de 8–15 horas al cierre de la funcionalidad 16. No se descuenta automáticamente el tiempo transcurrido ni se divide de nuevo entre agentes. Backend, interfaz e integración HTTP avanzan con propietarios de archivos y entregas revisables. Los nuevos módulos reciben validación completa; el alcance de mutación de las integraciones reutilizadas se determina por el cambio real.
