...
Contrato `features/project_states.feature` preparado y revisado; estado **spec_ready**, aprobado mediante la autorización global. La propuesta acotada está en `progress/proposal_project_states.md`. edit_project está cerrada localmente; todavía no se ha iniciado producción de estados. No requiere otra aprobación humana.
