  ...
  public DeliveryOutcome publish(OutboxMessage message) {
    String kind =
        switch (message.type()) {
          ...
          case "TaskStatusChanged.v1" -> "task-status-changed";
          case "BlockPlanned.v1" -> "block-planned";
          ...
          case "WorkSessionExtended.v1" -> "work-session-extended";
          default -> throw new IllegalArgumentException("Unsupported event type");
        };
    String queue =
        kind.equals("work-session-extended")
