...
class ReadAppearanceTest {
  ...
  void s1_readsConfirmedAbsenceForTheAuthenticatedOwner() {
    var read = new ReadAppearance(owner -> {
  ...
  void s2_readsTheStoredValuesAndRevisionWithoutChangingThem() {
    var value = new com.apptolast.organization.domain.Appearance(
        java.util.UUID.fromString("167989f4-2112-43ba-945d-1c690c974438"), "owner-a",
        "DARK", "#0000FF", "#00FFFF", 0,
