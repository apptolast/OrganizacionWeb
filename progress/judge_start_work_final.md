...
Actualización posterior: el replay terminó con EXIT 0 y 11/11 KILLED, sin supervivientes, errores o timeouts. Root cfa8a8 verificó XML y c41e81 confirmó 289 hashes idénticos antes/después. Los cinco supervivientes originales del record fueron detectados por WorkSessionPersistenceTest; los informes completos originales no cambian. No aparece ningún hallazgo que requiera reabrir el cierre. Evidencia en mutation_start_work_backend_replay.md.
