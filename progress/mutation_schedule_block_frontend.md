...
Ajuste documental de coordenadas: se regeneraron las 144 celdas Original de la tabla individual desde el source embebido del JSON preservado, usando start.column-1 y end.column-1 (intervalo de fin exclusivo). Se corrigieron 0 celdas aún desfasadas. Se verifican negaciones y primer carácter; no se modifican IDs, clasificaciones, reemplazos, resultados, fuentes/tests, configuración ni manifest/rangos. SHA256 del JSON preservado permanece `4c95f22fef3d0040e52303c96427351a11fefaa4358f9d8f070944b1ec003aec`. Las filas cuya expresión original no lleva ! (por ejemplo744/746/1530) conservan esa ausencia; no se inventa una negación.
