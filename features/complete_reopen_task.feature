@complete_reopen_task @approved
Feature: Completar y reabrir tareas conservando cada transición
  Contrato aprobado por autorización global del usuario después del cierre de split_task.
  La sección Feature 9 de project-spec.md completa sus decisiones técnicas.
  ...
  ETag: fuerte, con contenido task:<UUID canónico minúsculo>:<versión decimal canónica BIGINT no negativa>.
